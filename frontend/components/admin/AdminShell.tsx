...
export default function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen min-w-0 bg-surface text-text-primary xl:grid xl:grid-cols-[300px_minmax(0,1fr)]">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-[300px] max-w-[88vw] transform transition xl:static xl:max-w-none xl:translate-x-0 ${menuOpen ? 'translate-x-0' : '-translate-x-full xl:translate-x-0'}`}>
