...
const CATEGORIES = [
  {
    ...
    count: '80+ products',
    desc: 'High-purity solvents for degreasing, extraction, and manufacturing.',
  ...
  },
  {
    ...
    count: '120+ products',
    desc: 'Custom formulations and specialty compounds for advanced processes.',
  ...
  },
  {
    ...
    name: 'Lab Reagents',
    count: '200+ products',
    desc: 'Analytical grade reagents for research and quality control labs.',
  ...
  },
  {
    ...
    count: '90+ products',
    desc: 'Catalysts, inhibitors, and additives for industrial processes.',
    href: '/products?category=process-chemicals',
